...
title = r'Average Time Save Factor in i.i.d Zero Shot Generalization'
...
ax.fill_between(map_sizes, np.array(averages[0]) - np.array(iqrs[0])/2,
                np.array(averages[0]) + np.array(iqrs[0])/2,
                alpha=0.3, label='5% Obstacles IQR')  # Add label to the IQR region
...
title = 'Average Time Save Factor for Different Number of Agents'

plot(k_values,labels,title,0.1,0.7,timesave=True)
#########################################################################################################################################
k_values = ['SI K=0.25','3 agents','4 agents','5 agents','10 agents']
labels = ['2 agents','3 agents','4 agents','5 agents','10 agents']
title = 'Average Overlap for Different Number of Agents'
